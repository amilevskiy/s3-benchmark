...
![Benchmark results from a c5.4xlarge EC2 instance](https://github.com/dvassallo/s3-benchmark/blob/master/screenshots/c5.4xlarge_example.png?raw=true)

## Usage

### Download

#### macOS, Linux (x86_64, arm64, i386)
...
curl --silent --location --output - $( \
  ...
  sudo tar --directory /usr/local/bin --no-same-owner --xz --extract --file=- s3-benchmark
```
...
See [this](https://github.com/amilevskiy/s3-benchmark/blob/master/main.go#L130-L142) for all the other options.
...
[Daniel Vassallo](https://github.com/dvassallo/s3-benchmark) ran benchmark on all current generation EC2 instance types as of 2019-04-02. The data has been put in an interactive spreadsheet that you can [download here](https://github.com/dvassallo/s3-benchmark/blob/master/Analysis%20of%20S3%20Performance%20from%20EC2.xlsx?raw=true). Feel free to share it with your friends and colleagues.

### Analysis

Here's the maximum download throughput that has been got from all 155 instance types:
...
![S3 Throughput from All Instance Types](https://github.com/dvassallo/s3-benchmark/blob/master/screenshots/ec2_s3_perf_all_instances.png?raw=true)

And here's the same chart with just the 3 outlier instances that have 50 Gigabit or more network bandwidth:

![S3 Throughput from Outlier Instance Types](https://github.com/dvassallo/s3-benchmark/blob/master/screenshots/ec2_s3_perf_outlier_instances.png?raw=true)

Here's a typical throughput profile showing how object size affects performance:

![S3 Throughput by Object Size](https://github.com/dvassallo/s3-benchmark/blob/master/screenshots/ec2_s3_perf_by_object_size.png?raw=true)
...
![Time to First Byte Latency Small Instance](https://github.com/dvassallo/s3-benchmark/blob/master/screenshots/ec2_s3_perf_ttfb_small.png?raw=true)

And here's the p90 first byte latency on a larger instance:

![Time to First Byte Latency Large Instance](https://github.com/dvassallo/s3-benchmark/blob/master/screenshots/ec2_s3_perf_ttfb_large.png?raw=true)
...
![Time to Last Byte Latency](https://github.com/dvassallo/s3-benchmark/blob/master/screenshots/ec2_s3_perf_ttlb.png?raw=true)

If you want to analyze the data further, you can [download the spreadsheet](https://github.com/dvassallo/s3-benchmark/blob/master/Analysis%20of%20S3%20Performance%20from%20EC2.xlsx?raw=true) with all the raw data and the interactive features shown in the screenshots. Here's a [45 second demo](https://www.youtube.com/watch?v=f5CacEcWC9s) of what you can do with it.
